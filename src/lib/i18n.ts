...
export const siteCopy = {
  ja: {
    ...
    handson: {
      ...
      close: '閉じる',
      feedback: 'フィードバック',
      feedbackUrl: 'https://forms.office.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbRxfrxixxnh1AkgHlZ0RLul1UQ0dZSUM1V1Y0Vks2RUNEVElHUU9ZVjMySC4u',
      feedbackHint: 'アンケートを開く',
      copy: 'COPY',
      copied: 'COPIED ✓',
    },
    skills: {
    ...
    secret: {
      ...
      found: '隠し部屋を発見した！',
      intro: 'やあ！Theo です。GitHub Copilot とこのサイトに興味を持ってくれてありがとう。1995 年、フランスのヴェルサイユで生まれ育ち、今は東京に住んでいます。漫画を読んだり、ビデオゲーム（特に RPG）で遊んだり、スポーツをしたり、日本各地の温泉に浸かったりするのが大好き。ソフトウェア開発にも惚れ込んでいて、だから今 GitHub で働いています！ここで学んだことを活かして、君が素晴らしいソフトウェアを作ってくれるのを楽しみにしているよ。',
