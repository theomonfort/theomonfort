...
export const siteCopy = {
  ja: {
    ...
    handson: {
      ...
      close: '閉じる',
      feedback: 'Feedback',
      feedbackUrl: 'https://forms.office.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbRxfrxixxnh1AkgHlZ0RLul1UNUNIN0tHWlhCSTkxUlJLVVdGM1lPNFJCVi4u',
      bugReportUrl: 'https://github.com/theomonfort/theomonfort/issues/new?template=feedback.yml',
      copy: 'COPY',
      copied: 'COPIED ✓',
    },
    skills: {
    ...
    secret: {
      ...
      found: '隠し部屋を発見した！',
      intro: 'やあ！Theo です。GitHub Copilot とこのサイトに興味を持ってくれてありがとうございます。1995 年、フランスのヴェルサイユで生まれ育ち、今は東京に住んでいます。漫画を読んだり、ビデオゲーム（特に RPG）で遊んだり、スポーツをしたり、日本各地の温泉に浸かったりするのが大好きです。ソフトウェア開発にも惚れ込んでいて、だから今 GitHub で働いています！ここで学んだことを活かして、あなたが素晴らしいソフトウェアを作ってくれるのを楽しみにしています。',
      body: '個人的な意見ですが、最終的に AI があっても、コードに違いを生むのは\nあなたがそこに注ぐ愛と努力、そしてあなたのセンスだと思います。',
  ...
  en: {
    ...
    secret: {
      ...
      intro: 'Hi! My name is Theo, and thank you for your interest in GitHub Copilot and this website. I was born and raised in France in 1995, in Versailles, and I currently live in Tokyo, Japan. I enjoy reading manga, playing video games — especially RPGs — doing sports, and bathing in onsen around Japan. I also love software development, which is why I work at GitHub right now! I hope you go on to build amazing software with everything you have learned here — I can\u2019t wait to try it.',
      body: 'Just a personal thought: in the end, even with AI, what makes the\ndifference when you code is the love, the effort you put in,\nand the taste you have.',
      stat: '▶ HP +∞ / EXP +999 / EQUIP: PASSION',
      recommendationsHeading: '▼ BONUS: A FEW THINGS I LOVE ▼',
      interviewLabel: 'An interview I rewatch whenever I need to clear my head',
      interviewUrl: 'https://www.youtube.com/watch?v=rDqQcmVqAm4',
      albumLabel: 'The best album of all time \u2014 composed by two Frenchies',
      albumUrl: 'https://www.youtube.com/watch?v=wIMSU8otS-g&list=RDwIMSU8otS-g&start_radio=1',
    },
    notFound: {
