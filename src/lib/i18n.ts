  ...
  ja: {
    ...
    skills: {
      ...
      sections: {
        ...
        mcp: { heading: '🔌 MCP サーバー', count: '個の接続', body: 'Model Context Protocol = AI と外部ツール／データを繋ぐ USB-C。一度差せばどのモデルでも動く。' },
  ...
  en: {
    ...
    skills: {
      ...
      sections: {
        ...
        mcp: { heading: '🔌 MCP servers', count: 'connections', body: 'Model Context Protocol is the USB-C between AI and external tools or data.' },
    ...
    skillGallery: {
      setupSummary: '▶ First-time setup (install the gh skill extension)',
      setupIntro: '"gh skill" is a GitHub CLI extension. Run this once:',
      setupAfter: 'Then copy the install command for the skills you want from the cards below.',
      global: 'Global ~/',
      project: 'Project .github/',
      savePrefix: '💾 Save point · ',
      selected: 'selected',
      all: 'all equipment',
      copySuffix: ' copy',
