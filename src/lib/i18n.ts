...
export const siteCopy = {
  ja: {
    ...
    secret: {
      ...
      found: '隠し部屋を発見した！',
      intro: 'やあ！Theo です。Copilot とこのサイトに興味を持ってくれてありがとう。1995 年、フランスのヴェルサイユで生まれ育ち、今は東京に住んでいます。漫画を読んだり、ビデオゲーム（特に RPG）で遊んだり、スポーツをしたり、日本各地の温泉に浸かったりするのが大好き。ソフトウェア開発にも惚れ込んでいて、だから今 GitHub で働いています！ここで学んだことを活かして、君が素晴らしいソフトウェアを作ってくれるのを楽しみにしているよ。',
      quote: 'フォースと共にあらんことを、友よ。',
      body: '忘れないで ── 最終的に AI があっても、コードに違いを生むのは、\n君がそこに注ぐ愛と努力、そして君のセンスだから…',
      stat: '▶ HP +∞ / EXP +999 / 装備: PASSION',
      recommendationsHeading: '▼ おまけ：俺のオススメ ▼',
      interviewLabel: 'アイデアを整理したいときに何度も見返すインタビュー',
