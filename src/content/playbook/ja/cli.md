...
| `/settings` | CLI のユーザー設定を確認・変更する。 |
| `/env` | CLI が見ている環境情報を確認する。 |

## CLI Extensions

`gh` CLI の Extension と同様に、Copilot CLI でもサードパーティ製 extension を追加できる。詳細は <a class="retro-link" href="https://docs.github.com/en/copilot/how-tos/copilot-cli/cli-extensions" target="_blank" rel="noopener noreferrer">公式 how-to ↗</a> を参照。
