...
> 📖 ビルトインエージェントの最新の一覧と説明は、公式ドキュメント <a href="https://docs.github.com/en/copilot/concepts/agents/copilot-cli/about-custom-agents#built-in-agents" target="_blank" rel="noopener noreferrer" class="retro-link">Copilot CLI — Built-in agents</a> を参照。
