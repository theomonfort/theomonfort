...
<div style="font-size:1.25em;font-weight:bold;color:#9bbc0f;margin-bottom:0.35em;">GitHub Copilot = オーケストレーション層</div>
<div style="color:rgba(232,244,255,0.8);font-size:0.95em;line-height:1.5;">Claude + Gemini + Codex + Microsoft を、統制・監査可能な <strong>単一プラットフォーム</strong> で動かせるのは Copilot だけ。</div>
</div>
