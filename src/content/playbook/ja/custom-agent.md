...
| 開発タスク | ベストなモデル（例） |
| --- | --- |
| 要件定義 | <span style="color:#ffb000">Claude Opus 4.8</span> |
| アーキテクチャ・設計 | <span style="color:#ff2e88">Gemini 3.1 Pro</span> |
| コード計画 | <span style="color:#ffb000">Claude Opus 4.8</span> |
| コード生成 | <span style="color:#ffb000">Claude Sonnet 4.6</span> |
| テスト作成 | <span style="color:#ffb000">Claude Sonnet 4.6</span> |
| コードレビュー | <span style="color:#00f0ff">GPT-5.5 Codex</span> |
| CI/CD・自動化 | <span style="color:#00f0ff">GPT-5.4 Codex</span> |
| ドキュメント | <span style="color:#ff2e88">Gemini 3.1 Pro</span> |
| 大量処理・コスト重視 | <span style="color:#9bbc0f">MAI-Code-1-Flash</span> |
...
> 出典：SWE-bench Verified + Terminal-Bench + コミュニティ各種分析。モデルはあくまで一例で、タスクや好みによって変わる。
