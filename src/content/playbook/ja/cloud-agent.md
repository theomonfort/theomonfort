...
> 💡 詳細は <a href="https://docs.github.com/en/copilot/how-tos/use-copilot-agents/cloud-agent/use-cloud-agent-with-mcp" target="_blank" rel="noopener noreferrer" class="retro-link">Use Cloud Agent with MCP</a> を参照。
