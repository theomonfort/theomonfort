...
GitHub は開発のすべてを 1 つのプラットフォームに統合する ──
...
<svg viewBox="0 0 1080 520" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;display:block;font-family:'DotGothic16','Courier New',monospace;">
  ...
  <g>
    ...
    <text x="128" y="106" fill="#00f0ff" font-size="17" font-weight="bold">統合プラットフォーム</text>
    <text x="128" y="132" fill="#e8f4ff" font-size="13">エンタープライズ規模を 1 つに</text>
  </g>
  ...
  <g>
    ...
    <text x="128" y="398" fill="#ff2e88" font-size="17" font-weight="bold">開発者コラボレーション</text>
    <text x="128" y="424" fill="#e8f4ff" font-size="13">業界でベストな開発体験</text>
  </g>
  ...
  <g>
    ...
    <text x="826" y="106" fill="#ffb000" font-size="17" font-weight="bold">全工程にセキュリティ</text>
    <text x="826" y="132" fill="#e8f4ff" font-size="13">計画から運用まで保護</text>
  </g>
  ...
  <g>
    ...
    <text x="826" y="398" fill="#9bbc0f" font-size="17" font-weight="bold">全工程に AI を搭載</text>
    <text x="826" y="424" fill="#e8f4ff" font-size="13">Copilot が一気通貫で支援</text>
  </g>
</svg>
</figure>
