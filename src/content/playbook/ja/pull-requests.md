...
<p class="figtabs-cap">PR ごとに <b>1 コミット</b>へまとめて <code>main</code> に載せる。ログは最もきれいだが、個々のコミットは失われる。</p>
</div>
...
<p class="figtabs-cap">すべてのコミットを順に <code>main</code> へ載せ直す。<b>マージコミットのない直線的な履歴</b>になる。</p>
</div>
</div>
