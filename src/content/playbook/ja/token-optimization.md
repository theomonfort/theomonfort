...
<div style="padding:1.4em 1.2em;border:1px solid rgba(155,188,15,0.35);background:rgba(5,6,15,0.5);"><div style="font-family:'JetBrains Mono','Courier New',monospace;font-size:0.78em;letter-spacing:0.2em;color:#9bbc0f;text-transform:uppercase;margin-bottom:0.8em;">✓ ルール 01</div><div style="font-size:1.2em;font-weight:bold;color:#e8f4ff;margin-bottom:0.5em;line-height:1.3;">明確に</div><div style="color:rgba(232,244,255,0.65);font-size:0.95em;line-height:1.5;">目的・制約・「完了」の条件まで書く。</div></div>
<div style="padding:1.4em 1.2em;border:1px solid rgba(0,240,255,0.35);background:rgba(5,6,15,0.5);"><div style="font-family:'JetBrains Mono','Courier New',monospace;font-size:0.78em;letter-spacing:0.2em;color:#00f0ff;text-transform:uppercase;margin-bottom:0.8em;">✓ ルール 02</div><div style="font-size:1.2em;font-weight:bold;color:#e8f4ff;margin-bottom:0.5em;line-height:1.3;">停止条件を入れる</div><div style="color:rgba(232,244,255,0.65);font-size:0.95em;line-height:1.5;">「X なら止まれ」で探索の暴走を防ぐ。</div></div>
<div style="padding:1.4em 1.2em;border:1px solid rgba(255,176,0,0.35);background:rgba(5,6,15,0.5);"><div style="font-family:'JetBrains Mono','Courier New',monospace;font-size:0.78em;letter-spacing:0.2em;color:#ffb000;text-transform:uppercase;margin-bottom:0.8em;">✓ ルール 03</div><div style="font-size:1.2em;font-weight:bold;color:#e8f4ff;margin-bottom:0.5em;line-height:1.3;">事前にコンテキストを渡す</div><div style="color:rgba(232,244,255,0.65);font-size:0.95em;line-height:1.5;">ファイル・フォルダ・URL・エラーログ ── agent に探させないで済むものは全部。</div></div>
</div>
