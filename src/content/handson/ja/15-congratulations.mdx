...
本日はワークショップにご参加いただき、本当にありがとうございました 🙏

今後の改善のため、**[こちらのアンケートフォーム](https://forms.office.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbRxfrxixxnh1AkgHlZ0RLul1UNUNIN0tHWlhCSTkxUlJLVVdGM1lPNFJCVi4u)** にぜひご回答ください。皆さまの率直なフィードバックが、次回のワークショップをより良いものにする何よりの励みになります 🎉
